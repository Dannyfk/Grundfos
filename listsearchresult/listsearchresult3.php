<section class="listresult">
          <div class="listresultitem1">
            <div>
              <img class="listresultimage" src="../images/aplha3stor.png">
            </div>
          </div>
          ...
          <div class="listresultitem2">
            ...
            <div class="test">
              ...
              <button class="listresultbutton" type="button"><img class="listresultbuttonicon" src="../images/viewmaterialicon.png"><p class="listresultbuttondownloadtext">VIEW MATERIAL<p></button>
              </div>
        </section>